...
class Motorbike extends Vehicle {
  ...
  // DONE: Implement A wheelie method
  performWheelie(motorbikeObj: Motorbike): void {
    // DONE: The method should log the message "Motorbike [make] [model] is doing a wheelie!"
    console.log(`Motorbike ${motorbikeObj.make} ${motorbikeObj.model} is doing a wheelie!`);
  }
  ...
  override printDetails(): void {
    ...
    // DONE: The method should log the details of the Motorbike and include the VIN, make, model, year, weight, top speed, color, and wheels
